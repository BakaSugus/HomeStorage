        ...
        if (!_readOnly) {
            ...
            if (_resourceLocks.lock(transaction, path, tempLockOwner, false, 0,
                ...
                try {
                    ...
                    System.out.println(parentSo);
					if (parentSo == null) {
						// parent not exists
						resp.sendError(WebdavStatus.SC_CONFLICT);
                        System.out.println(WebdavStatus.SC_CONFLICT);
						return;
					}
					if (parentPath != null && parentSo.isFolder()) {
                        ...
                        if (so == null) {
                            ...
                            if (so.isNullResource()) {
                                ...
                                if (nullResourceLo == null) {
                                    ...
                                    System.out.println(WebdavStatus.SC_INTERNAL_SERVER_ERROR);
                                    return;
                                }
                                ...
                                if (lockTokens != null)
                                    ...
                                    System.out.println(WebdavStatus.SC_BAD_REQUEST);
                        ...
                        System.out.println(WebdavStatus.SC_FORBIDDEN);
