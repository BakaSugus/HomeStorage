...
public interface TextService {
    ...
    OriginFile getOrCreateAdminLogOriginFiles(String name);

    Files getOrCreateAdminLogFile(String name);

    Files GetOrCreateFolderLog(String prefix, String name, User user);
}
